...
# Adapted from DeepSeek-V4.1-Flash/inference/engram.py
# Source SHA256: 11f35ecbead8150c35aa002b3d180ef290b05a25afe883a11884f94d476d3897
...
class EngramLayout:
    ...
    primes: tuple[
        tuple[tuple[int, ...], ...], ...
    ]  # [layer][n-gram size][head] bucket modulus
    n_heads: int
    head_dim: int
...
class NgramHashState(nn.Module):
    ...
    def forward(
        ...
        products = (
            tokens.unsqueeze(2) * self.multipliers
        )  # [B, L, n_engram_layers, max_ngram_size]
