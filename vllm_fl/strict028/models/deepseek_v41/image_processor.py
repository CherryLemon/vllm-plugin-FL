...
# Adapted from DeepSeek-V4.1-Flash/inference/image_processor.py
# Source SHA256: 482759e3bcc4e9bb5ee582b244cc563f5d0e163d8b48dda91ebb7106e62f9272
...
def prepare_vl_inputs(prompt, images, tokenizer, args):
    ...
    if num_placeholders and not args.vision_enabled:
        raise ValueError(
            "The model config has no vision tower (vision_n_layers == 0) but the prompt contains images"
        )
