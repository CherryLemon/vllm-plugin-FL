...
class ModelRunnerFL(
    ...
    def _install_packed_block_table_arena(self) -> None:
        ...
        The environment switch is useful for incident rollback and is enabled
        by default for the all-on runtime.
        """
        ...
        disabled = os.getenv("VLLM_FL_PACKED_BLOCK_TABLE_ARENA", "1").lower()
